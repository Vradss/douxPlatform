-- ============================================================
-- MIGRACIÓN v6 — Nuevos campos de cliente: direccion_1, perfil_compra, comportamiento_compra
-- ============================================================

alter table public.clientes
  add column if not exists direccion_1 text,
  add column if not exists perfil_compra text,
  add column if not exists comportamiento_compra text;
